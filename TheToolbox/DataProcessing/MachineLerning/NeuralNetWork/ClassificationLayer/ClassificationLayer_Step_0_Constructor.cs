...
{
    public partial class ClassificationLayer
    {
        ...
        public void Preset_1_2nd_Set_w_b(double[,] W, double[,] B)
        {
            w = W;
            b = B;
        }
        public void Preset_1_2nd_Set_w_b(int input_dimension, int output_dimension)
        {
            w = new double[output_dimension, input_dimension];
            for (int j = 0; j < w.GetLength(0); j++)
            {
        ...
        public void Preset_2_2nd_Set_Hyper_Parameter(double Gamma, double L1, double L2, double Drop_out)
        {
