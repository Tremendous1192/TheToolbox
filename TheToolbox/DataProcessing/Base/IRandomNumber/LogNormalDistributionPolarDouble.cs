...
namespace TheToolbox.DataProcessing.Base
{
    public partial class LogNormalDistributionPolar : IRandomNumber
    {
        ...
        /// constructor
        /// </summary>
        public LogNormalDistributionPolar()
        {
        ...
        public LogNormalDistributionPolar(uint the_seed_1, uint the_seed_2)
        {
            seed_1 = the_seed_1;
        ...
        retry_point:
            ...
            resultDouble = Math.Exp(resultDouble);
            return resultDouble;
        }
        ...
        retry_point:
            ...
            resultDouble = Math.Exp(resultDouble * Math.Abs(std) + average);
            return resultDouble;
        }
